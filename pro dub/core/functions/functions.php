...
function allocation()
{
  ...
  $link=mysqli_connect('localhost','root','','suser');
	...
	if($rel == 1)
	{
		echo "<h1>Your Hall is allocated for the time given. Thank you!</h1><a href = content.php>go back to home</a>";
	}
	else {
...
function upload()
{
	...
	$sql = mysqli_query($link,"INSERT INTO files(name,size,type)VALUES ('$uploadfile','$size','$type')");
